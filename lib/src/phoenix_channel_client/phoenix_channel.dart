...
import 'package:app/src/phoenix_channel_client/phoenix_push.dart';
import 'package:app/src/phoenix_channel_client/phoenix_socket.dart';
...
class PhoenixChannel {
  ...
  PhoenixChannel(this._topic, this._params, this.socket) {
    ...
    on(PhoenixChannelEvents.reply, (payload, ref, _) {
...
///       return payload;
///     }
typedef PhoenixMessageCallback = Function(
